    ...
    <div className="__helper_header h-[50px] bg-slate-950 text-white p-2 flex justify-between items-center">
      <div className="__btn_container flex gap-1">
        <Button
          ...
          className="flex justify-center items-center gap-1 bg-green-600"
          variant="secondary"
        ...
        <DialogTrigger
          className="whitespace-nowrap rounded-md text-sm 
            ...
            hover:bg-secondary/80 h-9 px-4 py-2 flex justify-center items-center gap-1"
        >
          <Share2 size={16} />
          Share
        </DialogTrigger>
            ...
            <DialogDescription className="flex flex-col gap-1">
              <div className="__url flex gap-1">
                <input
                  type="text"
                  disabled
                  className="w-full px-2 py-2 rounded-sm bg-slate-800 text-slate-400 select-none"
